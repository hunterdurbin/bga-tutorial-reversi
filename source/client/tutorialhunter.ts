 ...
 * -----
 */
/// <amd-module name="bgagame/tutorialhunter"/>

import Gamegui = require('ebg/core/gamegui');
import "ebg/counter";

/** The root for all of your game code. */
class TutorialHunter extends Gamegui
{
...
// The global 'bgagame.tutorialhunter' class is instantiated when the page is loaded. The following code sets this variable to your game class.
dojo.setObject( "bgagame.tutorialhunter", TutorialHunter );
// Same as: (window.bgagame ??= {}).tutorialhunter = TutorialHunter;